<%-- 
    Document   : ticket
    Created on : 28-Jun-2022, 10:47:06 pm
    Author     : Kumar
--%>
    ...
    <script>
        function success(){
            <%
                    ...
                    String amt=(String)s.getAttribute("amount");
            %>
...
<div class="input-box">
                    <input type="text" placeholder="Nick Name" class="name">
                    <i class="fa fa-user icon"></i>
                </div>
</div>
<div class="input-group">
                <div class="input-box">
                    <input type="email" placeholder="Email Adress" class="name">
...
<div class="input-group">
                <div class="input-box">
                    <button type="submit" onclick="success()">PAY <%=amt%></button>
                </div>
</div>
</form>
</div>
